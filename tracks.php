...
<div>
  ...
  if(isset($_POST['search'])) {
    ...
    $query = mysqli_query($conn, "SELECT trID, trTitle, artName, cdTitle, trDuration FROM tracks, Artist, CD WHERE (tracks.artID = artist.artID) AND (tracks.cdID = cd.cdID) AND (artName LIKE '%$search%' OR cdTitle LIKE '%$search%' OR trTitle LIKE '%$search%' OR trDuration LIKE '%$search%')") or die ("Could not search");
...
<?php
  ...
  $sql = "SELECT trID, trTitle, artName, cdTitle, trDuration FROM tracks, Artist, CD WHERE (tracks.artID = artist.artID) AND (tracks.cdID = cd.cdID)";
